...
public class InitialInfoImpl implements Serializable
{
    ...
    public int victory_condition = 0; // victory condition == 0 : premier vainqueur arrêt du jeu ; 1 : enlève les joueurs les uns après les autres , 2 : au temps
    ...
    public int playMode ; // 0 : tour par tour, 1 : dès qu'on peut, 2 : au temps
